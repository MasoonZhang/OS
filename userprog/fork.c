...
static int32_t copy_pcb_vaddrbitmap_statck0(struct task_struct* child_thread, struct task_struct* parent_thread) {
...
static int32_t copy_process(struct task_struct* child_thread, struct task_struct* parent_thread) {
    ...
    if (copy_pcb_vaddrbitmap_statck0(child_thread, parent_thread) == -1) {
        return -1;
    }
